 ...
 */
final class Version20230601113506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, ride_id INT DEFAULT NULL, rule_id INT DEFAULT NULL, rides_id INT DEFAULT NULL, reservation_id INT DEFAULT NULL, car_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone VARCHAR(30) NOT NULL, created DATE NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649302A8A70 (ride_id), INDEX IDX_8D93D649744E0351 (rule_id), INDEX IDX_8D93D649B744E693 (rides_id), INDEX IDX_8D93D649B83297E7 (reservation_id), INDEX IDX_8D93D649C3C6F69F (car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
